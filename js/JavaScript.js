...
//     var val =(e.pageX - progress.getBoundingClientRect().left ) / (progress.getBoundingClientRect().right -progress.getBoundingClientRect().left),
...
//     ind =segmentArr.sort((a,b) => Math.abs(val-a))[0];
//     progress.value = segCopy.indexOf(ind) +1;
// }
